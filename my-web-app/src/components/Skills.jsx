        ...
        <div className='skillsContainer' id='skills'>
            <div className='firstSkillGrid'>
                <div className='box' style={{ gridArea: "box-1" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/biceps.png" className='imgSkill' alt="" />
                    </div>
                </div>

                <div className='box' style={{ gridArea: "box-2" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/html.png" className='imgSkill' alt="" />
                    </div>
                </div>
                ...
                <div className='box' style={{ gridArea: "box-4" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/css.png" className='imgSkill' alt="" />
                    </div>
                </div>
                ...
                <div className='box' style={{ gridArea: "box-6" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/games.png" className='imgSkill' alt="" />
                    </div>
                </div>

                <div className='box' style={{ gridArea: "box-7" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/js.png" className='imgSkill' alt="" />
                    </div>
                </div>

                <div className='box' style={{ gridArea: "box-8" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/painting.png" className='imgSkill' alt="" />
                    </div>
                </div>

                <div className='box' style={{ gridArea: "box-9" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/racing-car.png" className='imgSkill' alt="" />
                    </div>
                </div>
            ...
            <div className='secondSkillGrid'>
                <div className='box' style={{ gridArea: "box-10" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/restaurant.png" className='imgSkill' alt="" />
                    </div>
                </div>
                ...
                <div className='box' style={{ gridArea: "box-12" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/typescript.png" className='imgSkill' alt="" />
                    </div>
                </div>

                <div className='box' style={{ gridArea: "box-13" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/java.png" className='imgSkill' alt="" />
                    </div>
                </div>

                <div className='box' style={{ gridArea: "box-14" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/nodejs.png" className='imgSkill' alt="" />
                    </div>
                </div>

                <div className='box' style={{ gridArea: "box-15" }}>
                    <div className='iconHolder'>
                        <img src="/src/assets/images/githubLogo.png" className='imgSkillGit' alt="" />
                    </div>
                </div>
